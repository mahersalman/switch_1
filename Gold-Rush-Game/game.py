...
import random
from element import get_Gold_Rush_Elements

class GoldRush(Matrix):
    Elements = get_Gold_Rush_Elements()
    PLAYER1 = 'player1'
    PLAYER2 = 'player2'
    WINNER_POINTS = 100
    ...
    def _generete_empty_board(self):
        for i in range(self.rows):
            self.matrix.append([self.Elements['Empty'].symbol]*self.cols)

    def _generete_random_board(self):
        self._generete_empty_board()
